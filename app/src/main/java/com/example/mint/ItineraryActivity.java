        ...
        if (itinerary.getPointSize() > 0){
            ...
            if (itinerary.getPointSize()>2){
                ...
                for (int k=1;k<itinerary.getPointSize()-2;k++){
                    ...
                    // get the different textViews from the base view
                    ...
                    // amount of minutes it takes to travel this step
                    int timeMin = (itinerary.getStepTime().get(k-1) % 3600)/60;

                    // remaining seconds
                    int timeSec = (itinerary.getStepTime().get(k-1) % 60 );

                    // set time and distance as texts
